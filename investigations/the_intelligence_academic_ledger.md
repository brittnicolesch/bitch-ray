...
graph TD
    %% Define styles
    classDef doctrine fill:#4d0000,stroke:#ff0000,stroke-width:2px,color:#fff
    classDef academic fill:#003366,stroke:#66b3ff,stroke-width:2px,color:#fff
    classDef asset fill:#336600,stroke:#99ff33,stroke-width:2px,color:#fff
    classDef tech fill:#2d2d2d,stroke:#ff3333,stroke-width:2px,color:#fff

    %% The Doctrine
    Paperclip["Operation Paperclip (The Doctrine) <br> 'Shielding horrific actors for strategic advantage'"]:::doctrine

    %% The Academic Laboratory
    SFI["Santa Fe Institute (SFI) <br> Complexity Science & Behavioral Algorithms"]:::academic
    
    %% The Assets
    Epstein["Jeffrey Epstein (Intelligence Asset / Funder)"]:::asset

    %% The Modern Application
    Palantir["Palantir / Data Brokers"]:::tech
    Oligarchs["The Tech Oligarchy (Thiel, Musk, Hoffman)"]:::tech

    %% Evolution
    Paperclip ===>|"Doctrinal Precedent"| Epstein
    Epstein -->|"Funds algorithmic research"| SFI
    SFI -->|"Predictive Models & Social Graphing"| Palantir
    Paperclip ===>|"Modern Doctrinal Shield"| Oligarchs
